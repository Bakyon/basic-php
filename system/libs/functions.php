...
function singleUpload($file, $folder, $name = 'img_', $msg = '', $types = ['.jpg', '.jpeg', '.png', '.svg'], $maxsize = 3) {
    ...
    return $flag ? alert_success_msg($msg) : alert_danger_msg($msg);
}
...
function alert_success_msg($msg) {
    return '<div class="alert alert-success alert-dismissible fade show" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button><strong>'.$msg.'</strong></div>';
}

function alert_danger_msg($msg) {
    return '<div class="alert alert-danger alert-dismissible fade show" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button><strong>'.$msg.'</strong></div>';
}
